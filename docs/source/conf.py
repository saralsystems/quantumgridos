...
latex_documents = [
    ("index", "quantumgridos.tex", "QuantumGridOS Documentation", "SARAL Systems", "manual"),
]
...
man_pages = [("index", "quantumgridos", "QuantumGridOS Documentation", [author], 1)]
